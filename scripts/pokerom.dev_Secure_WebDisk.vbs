' pokerom.dev Secure WebDisk.vbs
'
...
' *************************************************************************
strURL = "\\pokerom.dev@SSL@2078\DavWWWRoot" ' This is the URL to the WebDAV share.
strDomainPort = "pokerom.dev@SSL@2078"
...
Sub CreateShorty ()
   ...
   strName = "pokerom.dev Secure WebDisk"
